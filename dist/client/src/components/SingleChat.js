...
const SingleChat = () => {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("div", { className: "w-full h-screen flex flex-col" },
            ...
            react_1.default.createElement("div", { className: " flex items-center justify-center  sticky bottom-0" },
                react_1.default.createElement("input", { type: "text", placeholder: "Type your message...", value: newMessage, onChange: (e) => setNewMessage(e.target.value), className: "flex-1 rounded-md outline-none p-4 " }),
